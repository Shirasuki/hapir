...
use crate::common::machine::HapirMachineMetadata;
use crate::common::metadata::HapirSessionMetadata;
use crate::common::modes::{ModelMode, PermissionMode, SessionMode};
...
pub enum UpdateBody {
    ...
    MsgDelta { sid: String, delta: MessageDelta },
}

...
mod tests {
    ...
    use super::metadata::{HapirSessionMetadata, SessionStartedBy};
    use super::modes::{AgentFlavor, ModelMode, PermissionMode};
    use super::session::Session;
    use super::sync_event::{ConnectionChangedData, MessageDeltaData, SyncEvent, ToastData};
    use super::todo::{TodoItem, TodoPriority, TodoStatus};
    ...
    fn metadata_serde_roundtrip() {
        let meta = HapirSessionMetadata {
            ...
            archived_by: None,
            archive_reason: None,
            flavor: Some(AgentFlavor::Claude),
            worktree: None,
        };

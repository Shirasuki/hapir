export default {
  ...
  'settings.display.theme': '颜色主题',
  'settings.display.theme.default': '默认',
  'settings.display.theme.claude': 'Claude',
  'settings.keyboard.title': '键盘',
  'settings.keyboard.sendShortcut': '发送快捷键',
  'settings.keyboard.sendShortcut.auto': '自动',
  'settings.keyboard.sendShortcut.enter': 'Enter',
  'settings.keyboard.sendShortcut.shiftEnter': 'Shift+Enter',
  'settings.keyboard.sendShortcut.cmdEnter': '⌘/Ctrl+Enter',

export default {
  ...
  'settings.display.theme': 'Color Theme',
  'settings.display.theme.default': 'Default',
  'settings.display.theme.claude': 'Claude',
  'settings.keyboard.title': 'Keyboard',
  'settings.keyboard.sendShortcut': 'Send Shortcut',
  'settings.keyboard.sendShortcut.auto': 'Auto',

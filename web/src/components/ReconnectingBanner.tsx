...
import type { DisconnectReason } from '@/hooks/useSSE'

const reasonI18nKeys: Record<DisconnectReason, string> = {
    'heartbeat-timeout': 'reconnecting.reason.heartbeatTimeout',
    'closed': 'reconnecting.reason.closed',
    'error': 'reconnecting.reason.error',
}
...
export function ReconnectingBanner({
    ...
    const reasonLabel = reason ? t(reasonI18nKeys[reason]) : null
